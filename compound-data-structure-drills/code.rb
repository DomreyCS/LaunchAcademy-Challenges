...
# puts people.select {|name,info| info["children"] != nil}.length
# # * What are the names of the people who do not have children?
# puts people.select {|name,info| info["children"] == nil}.keys
...
puts sets_of_people[0].select {|name,info| info["company"].include?("m")}.keys
...
puts "does `box_1` contain a \"denim shirt\"?"
...
if box_1.any? { |item| item == "silver nail polish" }
...
puts "does `box_3` exclusively contain \"skinny jeans\"?"
puts box_3.all? { |jean| jean == "skinny jeans" }
